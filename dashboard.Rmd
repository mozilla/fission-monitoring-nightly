...
Hovering over each point reveals a pop-up displaying the build_id, value, error bar, and relative difference.
...
# }
# 
# ccr <- create.figure(crashes[['CONTENT_CRASHES_PER_HOUR']], title="(a) Content Crash Rate/Profile/1000 Hrs",
#                     yaxislab='Estimate',width=W/1.85,height=H,
#                     LA=90)
# cmr <- create.figure(crashes[['MAIN_CRASHES_PER_HOUR']], title="(b) Main Crash Rate/Profile/1000 Hrs",
#                     yaxislab='Estimate',width=W/1.85,height=H,
#                     LA=90)
# cgr <- create.figure(crashes[['GPU_CRASHES_PER_HOUR']], title="(c) GPU Crash Rate/Profile/1000 Hrs",
#                     yaxislab='Estimate',width=W/1.85,height=H,
#                     LA=90)
# cor <- create.figure(crashes[['GPU_CRASHES_PER_HOUR']],title="(d) OOM Crash Rate/Profile/1000 Hrs",
#                     yaxislab='Estimate',width=W/1.85,height=H,
#                     LA=90)
# vw(list(
#     config = list( legend = list(direction='horizontal',orient='top',title=NULL)),
...
and confidence intervals using bootstraping (`r bs_replicates` samples). All metrics are per client and each client has the same weight. For histogram aggregation, 
...
[here](https://github.com/mozilla/fission-monitoring-nightly/blob/main/dashboard.Rmd).
