...
* Filters `r tbl.crashes.raw` to only those enrolled in the rollout Performs subsequent aggregations at the client and `submission date` for specific crash types`.
