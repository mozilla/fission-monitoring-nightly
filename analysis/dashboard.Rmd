...
* Filters `moz-fx-data-shared-prod.telemetry.crashes` to only those enrolled in the rollout Performs subsequent aggregations at the client and `submission date` for specific crash types`.
